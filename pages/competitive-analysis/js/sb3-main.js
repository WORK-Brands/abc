jQuery(document).ready(function(){
	var intro = $('.sb3-intro-block'),
		projectsContainer = $('.sb3-projects-wrapper'),
		projectsSlider = projectsContainer.children('.sb3-slider'),
		singleProjectContent = $('.sb3-project-content'),
		sliderNav = $('.sb3-slider-navigation');
	...
	function checkMQ() {
		...
		return window.getComputedStyle(document.querySelector('.sb3-projects-wrapper'), '::before').getPropertyValue('content').replace(/'/g, "").replace(/"/g, "");
	}
