jQuery(document).ready(function(){
	var intro = $('.sb2-intro-block'),
		projectsContainer = $('.sb2-projects-wrapper'),
		projectsSlider = projectsContainer.children('.sb2-slider'),
		singleProjectContent = $('.sb2-project-content'),
		sliderNav = $('.sb2-slider-navigation');
	...
	function checkMQ() {
		...
		return window.getComputedStyle(document.querySelector('.sb2-projects-wrapper'), '::before').getPropertyValue('content').replace(/'/g, "").replace(/"/g, "");
	}
