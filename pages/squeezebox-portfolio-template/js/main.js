jQuery(document).ready(function(){
	var intro = $('.sb-intro-block'),
		projectsContainer = $('.sb-projects-wrapper'),
		projectsSlider = projectsContainer.children('.sb-slider'),
		singleProjectContent = $('.sb-project-content'),
		sliderNav = $('.sb-slider-navigation');
	...
	projectsContainer.on('click', '.sb-slider a', function(event) {
		var mq = checkMQ();
		event.preventDefault();
	...
	function checkMQ() {
		...
		return window.getComputedStyle(document.querySelector('.sb-projects-wrapper'), '::before').getPropertyValue('content').replace(/'/g, "").replace(/"/g, "");
	}
